...
ADD_BUTTON_OFFSET: Rect = Rect(190, 20, 1, 1)  # 从菜品名到"添加"按钮的偏移
BAR_START_X: int = 681
BAR_END_X: int = 865
BAR_Y: int = 522
MENU_SWIPE_BEGIN: list = [480, 623]
MENU_SWIPE_END: list = [480, 136]
        ...
        context.run_task("swipe_menu_bar", {
            "swipe_menu_bar": {
                "action": {
                    "type": "Swipe",
                    "param": {
                        "begin": [BAR_START_X, BAR_Y],
                        "end": [bar_target_x, BAR_Y],
                        "duration": 1000
                    }
                }
            }
