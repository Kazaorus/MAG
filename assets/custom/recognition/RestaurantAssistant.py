from typing import Dict, List, Optional, Tuple, Literal, Set, Any
...
WAREHOUSE_SWIPE_END: List[int] = [473, 160, 0, 0]

SHOP_ROI: List[int] = [284, 93, 958, 606]
SHOP_SWIPE_BEGIN: List[int] = [759, 605, 0, 0]
SHOP_SWIPE_END: List[int] = [759, 93, 0, 0]
